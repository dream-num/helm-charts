...
while IFS='=' read -r name value ; do
    ...
    $AUTH_COOKIE_DOMAIN $AUTH_OIDC_ENABLED $AUTH_OIDC_CLIENT_ID $AUTH_OIDC_CLIENT_SECRET $AUTH_OIDC_ISSUER $AUTH_OIDC_CALLBACK_URL $AUTH_ENABLED $UNIVER_ENABLED'< .env.dev)
